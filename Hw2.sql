...
--List all Ratings and how many films do we have totally according to their Ratings.
	...
	select	distinct film.rating,count (*) as counter
	from film
	where film.rating
...
--List all Actors and their film numbers per actor.
	...
	select	distinct concat (actor,first_name, “ ” , actor.last_name) as fullnamecount (*) as counter
